    ...
    public static void registerActivityLifecycleCallbacks(Application application) {
        ...
        countDownTimer = new CountDownTimer(SESSION_INTERVAL_TIME, 10 * 1000) {
            ...
            public void onFinish() {
                Log.i("SensorsDataAPI", "countDownTimer onFinish：" + mCurrentActivity.get());
        ...
        application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
            ...
            public void onActivityStarted(Activity activity) {
                ...
                if (timeDiff > SESSION_INTERVAL_TIME) {
                    if (!mDatabaseHelper.getAppEndEventState()) {
                        Log.i("SensorsDataAPI", "onActivityStarted trackAppEnd activity：" + activity);
                        trackAppEnd(activity);
                    }
                }

                if (mDatabaseHelper.getAppEndEventState()) {
                    Log.i("SensorsDataAPI", "onActivityStarted trackAppStart activity：" + activity);
            ...
            public void onActivityResumed(Activity activity) {
                Log.i("SensorsDataAPI", "onActivityResumed activity：" + activity);
                trackAppViewScreen(activity);
            }

            @Override
            public void onActivityPaused(Activity activity) {
                Log.i("SensorsDataAPI", "onActivityPaused activity：" + activity);
